export const PAYMENT_PLANS = [
  {
    ...
    prices: [
      { type: 'renewable', duration: 'Yearly', price: 180, encourage: 'Save $24/year', priceId: 'price_1TXztvQ9YgX6ekXrvEWItWdG' },
      { type: 'renewable', duration: 'Monthly', price: 17, encourage: '', priceId: 'price_1TXzLSQ9YgX6ekXrLtOWm5vZ' },
      { type: 'non-renewable', duration: 'One Year', price: 220, encourage: '', priceId: 'price_1TY01FQ9YgX6ekXrNcfiblDT' },
      { type: 'non-renewable', duration: 'One Month', price: 20, encourage: '', priceId: 'price_1TRXLUQ9YgX6ekXrwF32kcaz' },
    ],
  },
  {
    id: 'pro_plan',
